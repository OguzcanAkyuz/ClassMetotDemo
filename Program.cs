...

    {
        ...
        static void Main(string[] args)
        {
            ...
            Customer[] customers = new Customer[]
                ...
                new Customer() { Name = "Ahmet", Surname = "Teker", Id = 34 },
                new Customer() { Name = "Mehmet", Surname ="Capraz", Id = 23 }
            };
            ...
            Customer customer2 = new Customer() { Name = "Ahmet", Id = 24, Surname="Teker" };
            Customer customer3 = new Customer() { Name = "Mehmet", Id = 23, Surname="Capraz" };
